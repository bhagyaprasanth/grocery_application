...
public class Messages {
	public static final String LOGIN_ASSERTS_VALID = "Login Unsuccessfull";
	public static final String LOGIN_ASSERTS_INVALID = "Login Successfull";
	public static final String HOME_ASSERTS_LOGOUT = "Failed to logout";
	public static final String NEWS_ASSERTS_HOME_PAGE_LINK = "Did not redirect to home page as expected";
